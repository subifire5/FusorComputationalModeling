...
/**
 * A sample application that computes the Mandelbrot set. The area of the
 * Mandelbrot set which is to be computed is divided into tiles, and the tiles
 * are scheduled for execution as individual tasks. The tasks are processed
 * concurrently by all available devices. <br />
 * <br />
 * The actual computation of the Mandelbrot set is done by an OpenCL kernel
 * which uses the "Quad-Float" data type: A high-precision floating point data
 * type that is represented as a single float4.
 */
public class Mandelbrot {
     ...
     * @param args not used
     */
    public static void mainMandelbrot(String args[]) {
     ...
     * be printed for each tile
     */
    private static final boolean BENCHMARK = false;

    /**
     * Abstract base class for tasks that refer to a region of the Mandelbrot
     * set. The processColors method of this class may be implemented to either
     * fill the whole image with the preview, or to fill a small region of the
     * image with a single tile.
     */
    private abstract class Task {

        /**
         * The OpenCL memory object that the output should be written to
         */
        ...
        /**
         * The total area of the Mandelbrot set that the tile this task computes
         * belongs to
         */
        ...
        /**
         * Compute the "low word" of the given double value and return it as a
         * float
         *
         * @param a The value
         * @return The low word
        ...
        /**
         * Compute the "high word" of the given double value and return it as a
         * float
         *
         * @param a The value
        ...
        /**
         * Convert the given double value to an array containing the "low- and
         * high word" as float values
         *
         * @param d The value
        ...
        /**
         * Will execute this task with the given kernel on the given command
         * queue
         *
    ...
    /**
     * An implementation of a Task that computes one tile of the Mandelbrot set
     */
    ...
    /**
     * An implementation of a Task that computes the Mandelbrot set at a coarse
     * resolution. It will process the computed colors by filling the output
     * image with rectangles of the specified tile size.
     */
    private class PreviewTask extends Task {

        /**
         * The size in which the "pixels" will be painted for the preview, in
         * x-direction
         */
    ...
    /**
     * A class that takes {@link Task}s from the taskQueue, executes them and
     * repaints the image component.
     */
    private class TaskProcessor implements Runnable {
        ...
        /**
         * Creates a new TaskProcessor which will execute the given kernel on
    ...
    /**
     * Converts the given array (which contains numbers of iterations) into an
     * array of colors using the colorMap
     *
    ...
    /**
     * The component which will paint the image of the Mandelbrot set and the
     * selection rectangle
     */
    private class ImageComponent extends JComponent {
        ...
        /**
         * Computes the relative position of the given point inside the image
         * component, i.e. the position in [0,1]x[0,1]
         *
    ...
    /**
     * The OpenCL kernels which will actually compute the Mandelbrot set and
     * store the numbers of iterations in the memory object
     */
    private cl_kernel kernels[];

    /**
     * The OpenCL memory objects which store the number of iterations for each
     * pixel. One memory object for each tile.
     */
    private cl_mem iterationsMem[][];

    /**
     * The OpenCL memory object which stores the number of iterations for the
     * preview
     */
    ...
    /**
     * The {@link TaskProcessor}s which will execute the tasks for computing the
     * preview- and tile kernels
     */
    private TaskProcessor taskProcessors[];

    /**
     * The queue of Tasks that are about to be executed by the
     * {@link TaskProcessor}.
     */
    ...
    /**
     * An array which contains RGB colors. The number of iterations that are
     * computed by the Mandelbrot OpenCL kernels will be translated into colors
     * using this map.
     */
    ...
    /**
     * Initializes the OpenCL memory object and the BufferedImage which will
     * later receive the pixels
     */
    ...
    /**
     * Attach the mouse- and mouse wheel listeners to the imageComponent which
     * allow zooming and panning and selecting regions to zoom in
     */
    ...
    /**
     * Creates the panel containing the controls for the image computation
     * parameters, like image and tile size and the number of iterations.
     *
    ...
    /**
     * Creates and returns the panel containing the "view stack" list and the
     * control buttons for the views.
     *
    ...
    /**
     * Schedules tasks for computing the preview and the actual image of the
     * Mandelbrot for the current region.
     */
