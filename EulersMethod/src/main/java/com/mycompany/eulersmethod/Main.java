...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Particle p = new Particle(12.0, 12.0, 0.0);
        Particle p1 = new Particle(10.0, 10.0, 0.0);
        CollisionDetection c = new CollisionDetection(ih.eField);
        if (c.collisionCheck(p, p1)) {
